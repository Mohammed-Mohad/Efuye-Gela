...
const CommunityUpdate = () => {
  return (
    <div className="relative top-[530px] w-full flex flex-col items-center gap-4 px-4">
      <div className="w-[1430px] h-[144px] flex-col justify-start items-center gap-2 inline-flex">
